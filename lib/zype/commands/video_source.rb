...
module Zype
  class Commands < Thor
    desc "video-source:list", "List data sources"
    ...
    define_method "video_source:list" do
      ...
      puts "Found #{video_sources.size} data source(s)"
      puts "---"
    ...
    desc "video-source:create", "Create data source"
    ...
    desc "video-source:destroy", "Destroy data source"
